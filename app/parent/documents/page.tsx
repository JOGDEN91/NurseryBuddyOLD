...
import { ChildDocumentsCard } from "../children/[id]/ChildDocumentsCard";
...
export default function ParentDocumentsPage() {
  ...
  // Load children via /api/parent/profile (same as profile page)
  useEffect(() => {
    let cancel = false;
        ...
        <div className="mx-auto flex max-w-screen-sm flex-col gap-4 px-4 pb-24 pt-1">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm">
            ...
            <p className="mt-1 text-xs text-gray-500">
              Choose a child to see required documents, upload files, and check the
              status of any requests from your nursery.
            </p>
          </div>

          {/* Error card (e.g. if profile API failed) */}
          {error && (

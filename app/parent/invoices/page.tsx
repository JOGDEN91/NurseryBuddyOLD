// app/parent/invoices/page.tsx
"use client";

import React, { useEffect, useState } from "react";
import { useRouter } from "next/navigation";
import { ChildInvoiceCard } from "../children/[id]/ChildInvoiceCard";
...
export default function ParentInvoicesPage() {
  ...
  // Load children via /api/parent/profile (same source as the profile/documents pages)
  useEffect(() => {
    let cancel = false;
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="mx-auto flex max-w-screen-sm flex-col gap-4 px-4 pb-24 pt-1">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm">
            <h1 className="text-lg font-semibold">Invoices & payments</h1>
            <p className="mt-1 text-xs text-gray-500">
              Choose a child to see their estimated invoice amount based on hours attended, any funding entitlements, your
              nursery&apos;s rates and consumable charges. Although we are using real figures for accuracy and transparency, this is only for demonstrational purposes.
            </p>
          </div>
          ...
          {selectedChild ? (
            ...
            !error && (
              <div className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-600 shadow-sm">
                Select a child above to view their invoice estimate.
              </div>
            )
          )}
        </div>
